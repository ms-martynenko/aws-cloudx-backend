...
import { FRONTEND_URL, PARSED_FOLDER, UPLOADED_FOLDER } from "../../constants";
...
export class ImportService extends Construct {
	constructor(scope: Construct, id: string, props: ImportServiceProps) {
		...
		const productsLambdaIntegration = new aws_apigateway.LambdaIntegration(lambdaImportProductsFile);
